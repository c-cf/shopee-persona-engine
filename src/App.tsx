...
export default function App() {
  ...
  async function copyPageJson(variant: Variant) {
    ...
    const data = buildListingPageJson(project.product, buyer, getVariant(variant));
    try { await navigator.clipboard.writeText(JSON.stringify(data, null, 2)); notice('已複製此頁 JSON，包含目前的標題、文案、商品資訊與受眾。'); }
