...
export default function ListingPreview({ product, title, description, imageUrl, mobile = false }: { product: Product; title: string; description: string; imageUrl?: string; mobile?: boolean }) {
  return <div className={`listing-preview ${mobile ? 'mobile-preview' : ''}`}>
    ...
    <div className="shop-body">
      ...
      <div className="shop-product">
        <div><ProductImage src={imageUrl || product.image} className="shop-image" />{imageUrl && <small className="shop-note">AI 受眾情境示意圖，實際商品外觀請以原圖為準。</small>}</div>
